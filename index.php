...
<body>
    ...
    <div class="content">
        ...
        <section id ="register" class="article" style="padding: 50px 0;">
            ...
            <table>
            <tr>	<th><label for="name">Name:</label> </th>	<td><input type="text" name="name" id="name" size ="30" maxlength="30" required></td>	</tr>
            ...
            <tr>	<th><label for="confirm_password">Confirm Password:</label> </th>	<td><input type="password" name="confirm_password" id="confirm_password" size ="30" maxlength="30" required></td>	</tr>
